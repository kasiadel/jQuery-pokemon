var pokemonRepository = (function() {
  ...
  function addListItem(pokemon) {
    var listItem = $('<button type="button" class="btn btn-primary btn-lg btn-block"  data-toggle="modal" data-target="#pokemon-modal"></button>');
  ...
  //creating modal
      ...
      var pokemonHeight = $('<p class="pokemonHeight"></p>').text(`Height: ${pokemon.height} m`);
      var pokemonWeight = $('<p class="pokemonWeight"></p>').text(`Weight:  ${pokemon.weight} kg`);
      var pokemonTypes = $('<p class="pokemonTypes"></p>').text(`Types:  ${pokemon.types}`);
